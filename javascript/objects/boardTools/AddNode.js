...
AddNode.prototype.actionOn = function() {
    ...
    saver.save({action: 'insert', what2Add: 'node', board_id: board.id, xPos: x, yPos: y, color: '00d7dd', icon: 'none'}, Saver.types.CONTENT, true, newNode);
    ...
    if(board.nodeToolbar.element.is(":visible")) {
        var oldNode = board.nodeToolbar.getNodeRef();
    ...
    newNode.select(); //TODO Doesn't work?
